...
class WordPHP // Version v2.1.11 - Timothy Edwards - 8 Sept 2023
{
	...
	private function checkFormating(&$xml, $Pstyle, $Dcap)
	{
		...
		if (strstr($node,'w:lastRenderedPageBreak')) {
			...
			$this->pageId++;
			$t = '</div><div class="page swiper-slide" data-page="' . $this->pageId . '">';	
		}	
	...
	public function readDocument($filename, $imgcss)
	{
		...
		$text = "<div class='book swiper-wrapper'><div class='page swiper-slide' data-page='1'>"; // Provide a small margin around the html output
		while ($reader->read()) {
