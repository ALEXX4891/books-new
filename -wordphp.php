...
class WordPHP // Version v2.1.11 - Timothy Edwards - 8 Sept 2023
{
	...
	**/ 
	...
	{	
		...
		if (strstr($node,'w:lastRenderedPageBreak')) $t = '<article>------------End of page-----------</article>';					 
...
// ------------------- END OF TABLE PROCESSING ------------------------
	...
	public function readDocument($filename,$imgcss)
	{
		...
		$text = "<div class='page' style='padding:20px;'>"; // Provide a small margin around the html output
		while ($reader->read()) {
